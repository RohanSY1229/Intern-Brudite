...
public class ResultsData {
    ...
    public void getBestStudent() {
        Map<Student, List<Integer>> mp = resultList.stream().collect(
                Collectors.groupingBy(Result::getStudent, Collectors.mapping(Result::getScore, Collectors.toList())));
        Integer maxMarks = 0;
        Student Best = new Student(0, null, null, 0l);
    ...
    public void getSecondBestStudent() {
        ...
        Student Best = new Student(0, null, null, 0l);
        Student secondBest = new Student(0, null, null, 0l);
        for (Student st : mp.keySet()) {
            List<Integer> allMarks = mp.get(st);
        ...
        System.out.println("Second best is " + secondBest.getName());
    }
    ...
    public void getSpecificStudent(String name) {
        Map<Student, List<Result>> mp = resultList.stream()
                .collect(Collectors.groupingBy(Result::getStudent, Collectors.toList()));
    ...
    public void getAllResults() {
        Map<Student, List<String>> mp = resultList.stream().collect(
                Collectors.groupingBy(Result::getStudent, Collectors.mapping(Result::toString, Collectors.toList())));
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || getClass() != obj.getClass())
            return false;
        ResultsData that = (ResultsData) obj;
